...
__global__ void gemv_warp_kb(
    ...
    // Process by K_blocks - each lane handles different K_blocks
    // This way we load scale factors much less often
    for (int kb = lane_id; kb < K_blocks; kb += WARP_SIZE) {
        ...
        // Process all 8 pairs in this K_block
...
void nvfp4_gemv(
    ...
    gemv_warp_kb<<<grid, threadsPerBlock, smem_size>>>(
